...
namespace SachlavimService.Utilities
{
    ...
    public sealed class SqlConnectDB
    {
        ...
        public static string GetConnectionString(int iConnectionServerID, bool bKeepSessionConnection)
        {
            int liConnectionServerID = iConnectionServerID;
            string sLogin = ConfigSettings.ReadSetting("Login");
            string sPassword = ConfigSettings.ReadSetting(ConfigSettings.GetConfigSettingByHost("Password"));
            string sDBServer = "";
            string sDataBaseName = ConfigSettings.ReadSetting(ConfigSettings.GetConfigSettingByHost("DataBaseName"));
            ...
            if (liConnectionServerID == 0)
                sDBServer = ConfigSettings.ReadSetting(ConfigSettings.GetConfigSettingByHost("DBServer"));
            else
                sDBServer = ConfigSettings.ReadSetting(ConfigSettings.GetConfigSettingByHost("AlternativeServer" + liConnectionServerID.ToString()));
    ...
    public class ConfigSettings
    {
        ...
        {
            //return key;
            switch (ConfigSettings.hostName)
            {
                case "SachlavimService":
                    return key + "-local";
                case "QA":
                    return key + "-qa";
